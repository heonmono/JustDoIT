# 코드 업 문제 몇개랑 인강 등 그냥 하루의 코드를 모으는 것이다.
# codeup의 문제나 fast campus강의 내용이지만 친절하게 정리하지 않아 참고는 힘들것이다.
# 작성자 남창헌(heon1580@gmail.com)

# 1157 : 특별한 공 던지기 1

n = float(input())

if n >= 50.0 and n <= 60.0 :
    print("win")
else :
    print("lose")
...
# 1173 : 30분전
hour, minute = map(int, input().split(" ")) # 특이점 0 시에서 23시
...
if minute >= 30 :
    ...
    if hour == 0 :
        ...
        hour -= 1
    minute = 60 - (30 - minute)
print(hour ,minute) # 음 +는 문자열끼리만 가능한건가?
# 1180 : 만능 휴지통
n = int(input())
...
t5, t_remain = t//300, t%300
t1, t_remain = t_remain//60, t_remain%60
t10, t_remain = t_remain//10, t_remain%10

if t_remain != 0 :
    print(-1)
else :
    print("%d %d %d" %(t5,t1,t10))
